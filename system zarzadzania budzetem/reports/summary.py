...
def summarize(transactions):
    ...
    amounts = [t.amount for t in transactions] # list comprehension – przetwarzanie listy w jednej linijce.
    if amounts:
...
def category_breakdown(transactions):
    ...
    breakdown = { #  dictionary comprehension – tworzenie słownika z przetworzonymi wartościami.
